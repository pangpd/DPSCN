...
from utils.disjoint_sample_split_data import load_disjoint_data, load_disjoint_hyper, load_joint_hyper
...
train_loader, test_loader, val_loader, num_classes, bands = load_joint_hyper(data_path, dataset, spatial_size=5)
